...
function Show-Usage {
    ...
    Write-Output ''
    Write-Output 'Prepare this checkout for Clinch development on Windows.'
    Write-Output ''
...
function Show-BootstrapPreview {
    Write-Output 'Clinch bootstrap is starting for Windows.'
    Write-Output 'It will:'
    Write-Output '  - Check for Git for Windows.'
    Write-Output '  - Install Rust if cargo is unavailable.'
    Write-Output '  - Install Visual Studio Build Tools, jq, CMake, and InnoSetup as needed.'
    Write-Output '  - Install Cargo test dependencies.'

    Write-Output 'Run .\script\windows\bootstrap.ps1 -Help to see available options.'
    Write-Output ''
}
