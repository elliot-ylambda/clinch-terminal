...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) remote_control_icon: MouseStateHandle,
    ...
    pub(super) file_explorer_icon: MouseStateHandle,
    pub(super) skills_icon: MouseStateHandle,
    pub(super) conversation_finder_icon: MouseStateHandle,
