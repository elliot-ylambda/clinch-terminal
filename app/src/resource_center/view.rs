...
impl ResourceCenterFooterItem {
    pub fn ui_label(&self) -> &'static str {
        match self {
            ...
            ResourceCenterFooterItem::GitHub => "GitHub",
    ...
    pub fn svg_path(&self) -> &'static str {
        match self {
            ...
            ResourceCenterFooterItem::GitHub => GITHUB_SVG_PATH,
...
impl ResourceCenterView {
    ...
    fn footer_item_click_action(
        ...
        match item {
            ...
            ResourceCenterFooterItem::GitHub => ctx.open_url(links::COMMUNITY_URL),
    ...
    fn render_footer_button(
        ...
        let mouse_state = match item {
            ...
            ResourceCenterFooterItem::GitHub => self.button_mouse_states.open_github.clone(),
    ...
    fn render_footer(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let github_button = self.render_footer_button(ResourceCenterFooterItem::GitHub, appearance);
        let feedback_button =
            self.render_footer_button(ResourceCenterFooterItem::Feedback, appearance);

        let footer = Flex::row()
            .with_child(docs_button)
            .with_child(github_button)
