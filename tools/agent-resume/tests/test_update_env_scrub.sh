...
for name in CLAUDE_CODE_SESSION_ID CLAUDE_CODE_BRIDGE_SESSION_ID \
  ...
  MAKEOVERRIDES MAKE_TERMOUT MAKE_TERMERR RELEASE_NOTES SKIP_SYNC \
  NO_COLOR FORCE_COLOR CLICOLOR CLICOLOR_FORCE NODE_DISABLE_COLORS CI CONTINUOUS_INTEGRATION; do
