...
fn register_tests() -> HashMap<&'static str, BoxedBuilderFn> {
    ...
    register_test!(test_clinch_update_requires_explicit_consent);
    ...
    register_test!(test_agent_resume_registry_reconciles_stale_snapshot);
    ...
    register_test!(test_file_tree_opens_image_in_image_pane);

    // Skills panel tests
    register_test!(test_skills_panel_lists_and_filters);
